 ...
 * 
 * Given a planof the plant.
 * The description should use at least, this should return a string that is the description t a few of the properties on the plant to form a sentence.
 * 
...
function describePlant(plant) {
    ...
    const plant =  "rose";
    const color =  "red";
    const groups = "concentric circle of pedals";
